...
function ebs_add_admin_menu() {
    add_menu_page('EBS Settings', ' EBS Settings', 'manage_options', 'ebs/ebs-settings.php', 'ebs_setting_page', get_template_directory_uri().'/admin/plugins/boostrap-shortcodes/images/icon.png');
}
...
function osc_add_admin_shortcode_scripts() {
    ...
    if ($screen->id == 'toplevel_page_ebs/ebs-settings') {
        wp_enqueue_style('ebs-setting', get_template_directory_uri().'/admin/plugins/boostrap-shortcodes/styles/ebs-setting.css');
    }
    if ('post-new.php' == $pagenow || 'post.php' == $pagenow) {
        ...
        wp_enqueue_script('jquery.fancybox',  get_template_directory_uri().'/admin/plugins/boostrap-shortcodes/js/jquery.fancybox.js');
        wp_enqueue_style('fancyboxcss', get_template_directory_uri().'/admin/plugins/boostrap-shortcodes/styles/jquery.fancybox.css');
        wp_enqueue_style('bootstrap-icon', get_template_directory_uri().'/admin/plugins/boostrap-shortcodes/styles/bootstrap-icon.css');
        wp_enqueue_style('bootstrap_admin', get_template_directory_uri().'/admin/plugins/boostrap-shortcodes/styles/bootstrap_admin.css');
    }
}
