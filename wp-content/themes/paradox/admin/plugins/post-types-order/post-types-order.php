...
define('CPTURL',    get_template_directory_uri().'/admin/plugins/post-types-order');
...
function cpto_plugin_menu() 
    {
        ...
        add_options_page('Post Types Order', 'Post Order', 'manage_options', 'cpto-options', 'cpt_plugin_options');
    }
