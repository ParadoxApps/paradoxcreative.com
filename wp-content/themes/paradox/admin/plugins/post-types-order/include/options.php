                    ...
                    ?>
                      <div class="wrap"> 
                        <div id="icon-options-general" class="icon32"></div>
                            <h2><?php _e('Post Order Settings', 'cpt') ?></h2>
                           
                            <form id="form_data" name="form" method="post">   
                                <br />
                                <h3 class="title"><?php _e('General', 'cpt') ?></h3>                              
                                <table class="form-table">
                                    <tbody>
                            
                                        <tr valign="top">
                                            <th scope="row"><label><?php _e('Who can re-order posts', 'cpt') ?></label></th>
                                            <td>
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><label><?php _e('Auto Sort', 'cpt') ?></label></th>
                                            <td>
                                                <label for="users_can_register">
                                                <input type="checkbox" <?php if ($options['autosort'] == "1") {echo ' checked="checked"';} ?> value="1" name="autosort">
                                                <?php _e("If checked, will automatically update the wp-queries to use the new order (<b>No code update is necessary</b>).<br /> If you need more order customizations you will need to uncheck this and include 'menu_order' into your theme queries", 'cpt') ?>.</label>
...
$args = array(
              ...
              'order'     => 'ASC'
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><label><?php _e('Admin Sort', 'cpt') ?></label></th>
                                            <td>
                                                <label for="users_can_register">
